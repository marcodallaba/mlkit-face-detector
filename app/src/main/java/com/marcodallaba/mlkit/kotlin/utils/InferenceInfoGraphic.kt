 ...
 */
package com.marcodallaba.mlkit.kotlin.utils
...
class InferenceInfoGraphic(
        private val overlay: GraphicOverlay, private val latency: Double, // Only valid when a stream of input images is being processed. Null for single image mode.
        private val framesPerSecond: Int?) : GraphicOverlay.Graphic(overlay) {
